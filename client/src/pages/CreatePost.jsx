  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]"> Create imagainative and visually stunning images gerated by DALL-E AI and share them with the community</p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button type='button' onClick={generateImage} className='text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center' >
            {generatingImg?"Gernerating...": "Generate"}
          </button>
        </div>
